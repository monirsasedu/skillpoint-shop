...
export default function CartCheckout() {
  ...
  function createOrder() {
    ...
    if (gateWay === PaymentGateway.MANUAL_PAYMENT) {
      if (!manual_payment_transaction_id || !manual_payment_proof) {
        toast.error(<b>Transaction ID and payment proof are required.</b>);
        return;
      }
    }
    ...
    mutate({
      ...
      ...(gateWay === PaymentGateway.MANUAL_PAYMENT && {
        manual_payment_transaction_id,
        manual_payment_proof,
        manual_payment_note,
      }),
